...
Working with the Entra Graph API to fetch **users and their roles** came with a few performance pitfalls:
...
These issues compounded, making the process slower and less reliable.
