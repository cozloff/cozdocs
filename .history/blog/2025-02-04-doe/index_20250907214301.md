...
- Integrated **automated testing** practices: finished xUnit tests, began Postman-based API end-to-end testing, and established shared cloud/lite local test environments.
